...
function App() {
  ...
  return <main className="app-shell">
    <aside className="rail"><div className="brand-mark">c<span>·</span></div><nav className="rail-nav" aria-label="Primary navigation"><button className="rail-button active" aria-label="Messages">◒</button><button className="rail-button" aria-label="Explore">⌕</button><button className="rail-button" aria-label="Notifications">♡</button><button className="rail-button" aria-label="Saved">▱</button></nav><button className="rail-button profile-button" aria-label="Open settings" onClick={openSettings}><div className="profile-dot">{name.slice(0, 2).toUpperCase()}</div></button></aside>
